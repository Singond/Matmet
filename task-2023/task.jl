...
md"""
Zároveň je poskytnuta periodická komponenta modelu,
tedy úhlová frekvence $\omega$:
"""

# ╔═╡ c00ad4b0-fd88-4081-917f-4ce689cb656d
ω = 0.16

# ╔═╡ aa6c97ba-bc5e-49c2-b0d5-68221e437a8a
with(legend=:none) do
	plot(t, I)
	title!("Naměřená data")
	xlabel!("čas t [s]")
...
# ╔═╡ 2ac6e3d0-be75-4bde-83f6-b53cb63a2dca
md"""
Počet datových bodů je $N$:
"""

# ╔═╡ feea8a0d-e04d-4d10-8e77-57b14ac8a637
N = length(t)

# ╔═╡ 8d9d7a96-81b2-4080-a7a8-30f6cfa96db3
md"""
Model
=====
Volíme modelovou funkci:
$m(t) = \beta_1 + \beta_2 t + \beta_3 t^2 + \beta_4 \cos(\omega t) + \beta_5 t \cos(\omega t) + \beta_6 t^2 \cos(\omega t) + \beta_7 \sin(\omega t) + \beta_8 t \sin(\omega t) + \beta_9 t^2 \sin(\omega t)$
"""

# ╔═╡ 858d5189-c558-439b-adcf-b1a88748fa3e
m(t, β, ω) = β[1] + β[2] * t + β[3] * t^2 +
	β[4] * cos(ω * t) + β[5] * t * cos(ω * t) + β[6] * t^2 * cos(ω * t) +
	β[7] * sin(ω * t) + β[8] * t * sin(ω * t) + β[9] * t^2 * sin(ω * t)

# ╔═╡ 4af367cc-622c-4484-aead-18269de23f4c
m(t, β) = m(t, β, ω)

# ╔═╡ c8327d42-576d-49d9-b2e5-e9acc79cc2f2
ct = cos.(ω * t)
...
begin
	plot(t, I, label="data")
	plot!(t, m.(t), label="fit")
	title!("Modelová funkce")
	xlabel!("čas t [s]")
	ylabel!("intenzita I")
end
